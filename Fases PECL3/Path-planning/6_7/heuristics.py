...
def manhattan(point, point2):
    return abs(point2.grid_point[0]-point.grid_point[0]) + abs(point2.grid_point[1]-point.grid_point[1])
...
def euclidean(point, point2):
    return math.sqrt(pow(point2.grid_point[0]-point.grid_point[0], 2) + pow(point2.grid_point[1]-point.grid_point[1], 2))
